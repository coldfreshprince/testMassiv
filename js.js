let question_arr = ['Метеором називається явище,коли:','З чого складається ядро комети?','Зорі якого спектрального класу мають найкоротше життя?','Який космічний об‘єкт називають пульсаром?','Що знаходиться в центрі Галактики?' ];
let a1_arr = ["Зорі падають на землю","З льоду та пилу","А","Подвійну зорю коли одна зоря заслоняє іншу","Зоряне скупчення"]
let a2_arr = ["Каміння падає на землю","Із заліза","В","Нейтронну зорю","Чорна діра"]
let a3_arr = ["Порошинки згорають у повітрі ","Із каміння","F","Білого карлика","Білий карлик"]
let a4_arr = ["Блискавки спостерігаються в повітрі ","З пари води","М","Пульсуючу зорю","Чорна хмара"]
let answer_arr = ["Порошинки згорають у повітрі ","З льоду та пилу","М","Нейтронну зорю","Чорна діра"]
